...
function makeService(over: any = {}) {
  const prisma = {
    ...
    withdrawal: {
      create: jest.fn(), update: jest.fn(), delete: jest.fn(), findFirst: jest.fn(),
    },
    ...(over.prisma ?? {}),
  }
  ...
  const svc = new StoresService(prisma as any, wallet as any, mpOauth as any, asaas as any)
  return { svc, prisma, wallet, asaas }
}
